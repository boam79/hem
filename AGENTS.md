...
자동 메모, 라운드 3, 인증·RLS, 실데이터 업로드.
페르소나 프로바이더·modelId 변경 UI는 불가(F5). 편집은 이름·역할·습관·temperature만.
설정·대시보드의 사용량/잔여는 Boardroom이 기록한 토큰 집계와 월 예산 대비이며, 각 사 계정 잔액은 콘솔 링크다.
