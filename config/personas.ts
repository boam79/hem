...
export const ROUND2_RULES = `6. 제공된 타 부서 발언 중 동의하지 않는 지점을 objection에 1개 이상 적고 이유를 붙입니다. 동의만 하고 반대를 빼지 않습니다. objection과 changed는 빈 문자열 금지.
7. changed에 입장 변경 여부를 적습니다. 바뀌었으면 원인을, 아니면 "유지: 이유"를 씁니다. 공란 금지.`;
